...
func _win_game():
	get_tree().change_scene("res://levels/cloud/cloud4.tscn")
...
func _ready():
	...
	get_node("Platform3").set_color(Color(0,0,1,1))
	get_node("Platform4").set_color(Color(1,1,0,1))
	get_node("Platform5").set_color(Color(0.5,0.5,0.5,1))
	get_node("ColorChanger").set_color(Color(0,0,1,1))
	get_node("ColorChanger2").set_color(Color(1,1,0,1))
